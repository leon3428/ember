...
ember::GouraudPhongMaterial::GouraudPhongMaterial()
    : Material(getResourceManager()->getShaderProgram("gouraudPhongShaderProgram"_id)),
      ambientColor(0.0f),
      diffuseColor(0.0f),
      specularColor(0.0f),
      shininess(0.0f),
...
auto ember::GouraudPhongMaterial::uploadUniforms() const -> void {
...
auto ember::GouraudPhongMaterial::uploadMvp(const glm::mat4 &model, const glm::mat4 &view,
