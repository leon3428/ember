#ifndef GOURAUD_PHONG_MATERIAL_HPP
#define GOURAUD_PHONG_MATERIAL_HPP

#include <glm/glm.hpp>
#include "material.hpp"

namespace ember {
class GouraudPhongMaterial : public Material {
 public:
  GouraudPhongMaterial();
...
#endif  // GOURAUD_PHONG_MATERIAL_HPP